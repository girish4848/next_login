    ...
    return (
        <ProtectedComponent>
            ...
            <main>
                ...
                <div class="px-4 py-6 sm:px-0 flex-col items-center justify-center">
                    
                    <div class="h-96 rounded-lg border-4 border-dashed border-gray-200 w-full flex-1 flex-col items-center justify-center">
                        <div class="grid grid-rows-3 grid-flow-col gap-4 flex-1 flex-col items-center justify-center">
                            <div class="col-span-3 ..."><button onClick={btnHandler} className='bg-green-300 flex-col items-center justify-center text-white px-3 py-1 m-1 rounded-2xl'>Welcome to Dashboard</button></div>
                            <div class="col-span-2 ...">{JSON.stringify(data)}</div>
